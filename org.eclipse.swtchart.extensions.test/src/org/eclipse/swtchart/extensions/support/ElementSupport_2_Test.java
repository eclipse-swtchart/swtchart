...
public class ElementSupport_2_Test {
	/*
	...
	public void test1() {
		...
		assertEquals(118054.99939795304, rectanglePrimary.getX(), 0);
		assertEquals(2274644.0031847134, rectanglePrimary.getY(), 0);
		assertEquals(22987.959060806752, rectanglePrimary.getWidth(), 0);
		assertEquals(147485.82802547817, rectanglePrimary.getHeight(), 0);
	}
	...
	public void test2() {
		...
		assertEquals(118054.99939795304, rectanglePrimary.getX(), 0);
		assertEquals(-2076122.4251592355, rectanglePrimary.getY(), 0);
		assertEquals(22987.959060806752, rectanglePrimary.getWidth(), 0);
		assertEquals(147485.82802547794, rectanglePrimary.getHeight(), 0);
	}
}
