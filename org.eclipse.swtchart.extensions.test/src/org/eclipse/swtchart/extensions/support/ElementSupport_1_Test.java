...
public class ElementSupport_1_Test {
	/*
	...
	public void test1() {
		...
		assertEquals(11904.62818336163, pointPrimary.getX(), 0);
		assertEquals(3306194.791942467, pointPrimary.getY(), 0);
	}
	...
	public void test2() {
		...
		assertEquals(41076.45500848896, rectanglePrimary.getX(), 0);
		assertEquals(3342455.441007211, rectanglePrimary.getY(), 0);
		assertEquals(32413.140916808145, rectanglePrimary.getWidth(), 0);
		assertEquals(226629.05665464886, rectanglePrimary.getHeight(), 0);
	}
}
