...
public abstract class AbstractExportHandler extends AbstractSeriesExportHandler {
	...
	private CommandSequence getCommandSequenceAutofixChart(Shell shell, PageSizeOption pageSizeOption, int indexAxisX, int indexAxisY, ScrollableChart scrollableChart) {
		 ...
		 */
		CommandSequence commandSequene = getCommandSequence(shell, pageSizeOption, indexAxisX, indexAxisY, scrollableChart);
		/*
	...
	private void executeClipboard(Document document, String typeName) throws IOException {
	...
	private void executeFile(Shell shell, Document document, String filterName, String filterExtension, String fileName, boolean openInEditor) throws IOException {
	...
	private void execute(File file, Document document, boolean openInEditor) throws IOException {
