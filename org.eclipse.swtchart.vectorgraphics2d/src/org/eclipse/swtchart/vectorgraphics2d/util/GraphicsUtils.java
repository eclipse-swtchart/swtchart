...
public abstract class GraphicsUtils {
	 ...
	 * 
	 * @param image
	 *            Rendered image that should be converted.
	...
	private static boolean isLogicalFontFamily(String family) {
		...
		return (Font.DIALOG.equals(family) || Font.DIALOG_INPUT.equals(family) || Font.SANS_SERIF.equals(family) || Font.SERIF.equals(family) || Font.MONOSPACED.equals(family));
	}
	 ...
	 *            Logical font object.
	 * @param testText
	 *            Text used to determine font properties.
	...
	public static BufferedImage getAlphaImage(BufferedImage image) {
		...
		int[] bits = {8};
		cm = new ComponentColorModel(colorSpace, bits, false, true, Transparency.OPAQUE, DataBuffer.TYPE_BYTE);
